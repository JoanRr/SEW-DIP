...
<!-- webpage content goes here in the body -->
		...
		<?php
			...
			if(strlen($passwort) == 0) {
				echo '<br>Bitte ein Passwort angeben<br>';
				$error = true;
										}
 ...
 //Überprüfe, dass die E-Mail-Adresse noch nicht registriert wurde
			...
			if($user !== false) {
				echo '<br>Diese E-Mail-Adresse ist bereits vergeben<br>';
				$error = true;
								} 
						}
 ...
 //Keine Fehler, wir können den Nutzer registrieren
			...
			if($result) { 
				echo '<br>Du wurdest erfolgreich registriert. <a href="login.php">Zum Login</a>';
				
				$showFormular = false;
						} else {
								echo '<br>Beim Abspeichern ist leider ein Fehler aufgetreten<br>';
								}
						} 
										}
